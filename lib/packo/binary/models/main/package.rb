...
require 'packo/binary/models/main/dependency'
require 'packo/binary/models/main/content'
...
class Package
  ...
  property :runtime, Boolean, :default => true  # Installed as build dependency
